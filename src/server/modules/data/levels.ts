...
// same shape knifeGame.ts expects (an array indexed by boss number).
//
...
export const BossLevels: KnifeLevelData[] = [
    {
        "level": 1,
        "apples": [
            0,
    ...
    },
    {
        "level": 2,
        "apples": [90, 250],
        "preAttachedKnives": [30, 60, 270, 330],
        "throwableKnives": 10,
        "changeTime": 1.3,
        "boss": {
            "name": "Boss1",
    ...
    },
    {
        "level": 3,
        "apples": [],
        "preAttachedKnives": [30, 60, 90, 120, 150],
        "throwableKnives": 6,
        "changeTime": 2.4,
        "boss": {
            "name": "Boss2",

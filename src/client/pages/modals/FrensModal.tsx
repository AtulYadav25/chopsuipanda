                            ...
                            return <div key={fren.username} className="border p-2 rounded-lg flex flex-col items-center bg-slate-100 py-4">
                                ...
                                <div className="flex space-x-4">
                                    <button onClick={() => respondToFriendRequest({
                                        friendUserName: fren.username,
                                        accepted: true
                                    })} className="px-6 py-2 bg-green-500 text-white rounded-md border-b-4 border-green-700 border-t-2 border-t-green-300">
                                        Accept
                                    </button>
                                    <button onClick={() => respondToFriendRequest({
                                        friendUserName: fren.username,
                                        accepted: false
                                    })} className="px-6 py-2 bg-red-800 text-white rounded-md border-b-4 border-red-900 border-t-2 border-t-red-500">
                                        Reject
                                    </button>
                                </div>
                            </div>
